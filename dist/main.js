...
var routes = [
    { path: 'dashboard', component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], resolve: { resolvedBooks: _core_book_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BooksResolverService"] } },
...
var BooksResolverService = /** @class */ (function () {
    ...
    BooksResolverService.prototype.resolve = function (route, state) {
        return this.dataService.getAllBooks()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(err); }));
    };
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        ...
        return this.http.get('/api/books')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) { return _this.handleHttpError(err); }));
    };
    DataService.prototype.handleHttpError = function (error) {
        var dataError = new app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_4__["BookTrackerError"]();
        dataError.errorNumber = 100;
        dataError.message = error.statusText;
        dataError.friendlyMessage = 'An Error occurred retrirving data.';
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (b) { return ({
            bookTitle: b.title,
            year: b.publicationYear
        }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (classicBook) { return console.log(classicBook); }));
    };
...
module.exports = __webpack_require__(/*! /Users/anuragbaral/Documents/Dev/angular-http-communication/booktracker/src/main.ts */"./src/main.ts");
